...
const OurProjects = () => {
  ...
  return (
    <div className='pt-[5%] '>
    <h1 className=' buyan lg:text-8xl md:text-5xl sm:text-3xl text-black ml-[8%] lg:mb-[8%]'>BIZNING LOYIHALAR</h1>
    ...
    <img src={circle6} alt="" className='w-[20%] lg:-mt-[48%] sm:-mt-0'/>
    <Link to={'/loyihalar'}><button className='text-black bg-transparent lg:text-xl border-[1px] border-black py-2 px-12 hover:bg-black hover:text-white lg:ml-[41%] md:ml-[41%] sm:ml-[13%] mt-[20%] '>Loyihalarni ko`rish</button></Link>
    </div>
  )
}
