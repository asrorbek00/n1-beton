  ...
  return (
    <div className='pl-[5%] mt-[25%]'>
       <div className='ml-[2%]'>
        ...
        <h1 className='texts lg:text-7xl md:text-5xl sm:text-3xl -mt-[35%]'>MAXSULOTLAR</h1>
       </div>
        ...
        {products && products.map((product)=>{
            ...
            {product.text}
                ...
                <Link to={'/maxsulotlar'} className='w-fit'><button className='lg:py-[2%] md:py-[2%] sm:py-0 border-[1px] border-black w-[70%] lg:ml-20  sm:ml-10 mt-[5%] hover:bg-black hover:text-white hover:border-[1px]'>Maxsulotlarni ko`rish</button></Link>
             </div>
        })}
