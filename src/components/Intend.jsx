...
const Intend = () => {
  ...
  return (
    ...
    {data && data.map((info)=>{
      return <>
      <div>
        <h1 className=' buyan  intenn lg:text-8xl md:text-5xl sm:text-3xl w-[70%] ml-[5%] mb-12'>BUTUN BETON MARKASINI YARATISH</h1>
        <div className='flex'>
            ...
            <div className=' flex flex-col lg:gap-20 md:gap-16 sm:gap-1'>
                <div className=' w-fit flex lg:gap-32 md:gap-30 sm:gap-6 pl-[40%] mb-2 border-b-4 border-black lg:pb-4 md:pb-3 sm:pb-1'>
                ...
                <div className=' w-fit flex lg:gap-32 md:gap-30 sm:gap-6 lg:pl-[45%] sm:pl-14 mb-2 border-b-4 border-black lg:pb-4 md:pb-3 sm:pb-1 lg:-ml-[10%]'>
                ...
                <div className=' w-fit flex lg:gap-32 md:gap-30 sm:gap-6 lg:pl-[600px]  sm:pl-14 mb-2 border-b-4 border-black lg:pb-4 md:pb-3 sm:pb-1 lg:-ml-[20%]'>
